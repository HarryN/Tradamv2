    ...
    <div className="max-w-5xl mx-auto space-y-10">
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-sm text-neutral-muted font-medium">{t('disputeCenterSub') || 'Manage and track your active disputes.'}</p>
        </div>
      ...
      {disputes.length === 0 ? (
        <div className="bg-white rounded-3xl border border-neutral-border p-16 text-center space-y-6 shadow-sm">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-neutral-muted max-w-xs mx-auto">{t('noDisputesSub') || 'You haven\'t opened any disputes yet.'}</p>
          </div>
        </div>
      ) : (
